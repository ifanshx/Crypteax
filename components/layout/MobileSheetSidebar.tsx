...
import { Rocket, Repeat2, Image, PartyPopper, Menu } from 'lucide-react';
    ...
    return (
        <Sheet>
            <SheetTrigger asChild className="md:hidden">
                {/* Menambahkan styling focus-visible untuk aksesibilitas dan konsistensi UI */}
            ...
            <SheetContent side="left" className="w-64 p-0 bg-white border-r-0">
                ...
                <div className="flex flex-col items-center py-4 space-y-8 h-full">
