...
export default async function MintPage({ params }: MintPageProps) {
    ...
    return (
        <div className="flex flex-col gap-6">
            <div className="relative w-full h-[250px] md:h-[350px] lg:h-[450px] rounded-xl overflow-hidden shadow-xl group">
                <Image
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-10 z-20 text-white">
                    <div className="flex flex-col sm:flex-row items-start sm:items-end gap-4 sm:gap-6 mb-4">
                        <div className="relative w-20 h-20 md:w-28 md:h-28 lg:w-32 lg:h-32 rounded-full overflow-hidden border-4 border-white shadow-lg">
                            <Image
                        ...
                        <div>
                            ...
                            <div className="flex items-center space-x-3 text-base md:text-lg font-semibold mt-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
                <div className="lg:col-span-2 bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md flex flex-col gap-6">
                    ...
                    <div className="mt-4 flex flex-wrap gap-3 md:gap-4 items-center">
                ...
                <div className="lg:col-span-1 bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md flex flex-col gap-6 items-center justify-center">
                    ...
                    {collection.status === 'Live' && collection.maxSupply && collection.maxSupply > 0 && (
                        <div className="w-full text-center mb-4">
                            <div className="relative pt-1">
                                ...
                                <div className="flex justify-between text-xs md:text-sm font-medium text-gray-600 dark:text-gray-400 mt-2">
                    ...
                    {collection.status === 'Live' && (
                        <div className="text-center w-full">
                            ...
                            <p className="font-extrabold text-2xl md:text-3xl text-gray-900 dark:text-white mb-6">{collection.mintPrice} {collection.mintCurrency}</p>
